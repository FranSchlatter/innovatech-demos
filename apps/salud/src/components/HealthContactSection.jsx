...
import { Mail, Phone, MapPin, CheckCircle, Clock, Instagram, Facebook, Linkedin, Twitter, Calendar } from 'lucide-react'
import { useState } from 'react'

export default function HealthContactSection() {
  ...
  const contactInfo = [
    {
      ...
      value: '+1 (305) 911-0000',
      href: 'tel:+13059110000',
    ...
    },
    {
      icon: Mail,
      label: 'Email Us',
      value: 'contact@healthcenter.com',
      href: 'mailto:contact@healthcenter.com',
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-lg text-muted max-w-2xl mx-auto">
            Our medical team is ready to assist you. Reach out for appointments or inquiries
          </p>
        </motion.div>
